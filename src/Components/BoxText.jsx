  ...
  return (
    <>
     <div className='bg-green py-10 px-2 md:px-10 lg:px-20 flex flex-col gap-3 rounded-md'>
       <div className='leading-snug px-0 sm:px-10 md:px-16 lg:px-20 md:w-3/4 md:mx-auto'> <Heading1 heading1={props.heading1} /></div>
      <div className='text-black md:w-3/4 md:mx-auto'><Para1 para1={props.para} /></div>
