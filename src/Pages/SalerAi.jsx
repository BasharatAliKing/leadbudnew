                            ...
                            <div className='container flex flex-col md:flex-row gap-2 md:gap-3 '>
                                <div className='md:w-1/2 flex flex-col justify-center gap-3 mt-10'>
                                    ...
                                    <ul className='flex flex-col gap-3'>
                                        ...
                                        <form onSubmit={handleSubmit} className='rounded-md flex h-10 md:w-3/4  shadow-lg shadow-[#505050] '>
                                            ...
                                            <button  className='bg-black rounded-r-md text-white font-semibold text-sm md:text-md flex items-center justify-center w-48 h-10 duration-700 hover:bg-white border-2 border-black hover:text-black'>Start Trail</button>
                                        </form>
