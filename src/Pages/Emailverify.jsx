                  ...
                  <div className='flex flex-col gap-3  border-l-0 border-b-2 border-r-0 lg:border-r-2  lg:border-b-0 border-t-0 p-3'>
                    ...
                    <div>
                      <div className='flex flex-col gap-3'>
                        ...
                        <div className='state-tooltop relative cursor-pointer flex items-center justify-between text-xs mt-1 md:text-[15px]'>
                          <div className='statetooltip-text -top-[70px] lg:-top-[85px]  duration-700 absolute bg-black text-white p-2 text-[10px] rounded-md '>
                            {(num >= 0 && num < 30) ?
                              <div className='flex flex-col gap-1'>
                                <h3 className='text-[13px] font-medium md:text-[15px]'>UnDeliverable</h3>
                                <p className='font-normal leading-snug'>Email Address is not associated with a valid account or should not be emailed.</p>
                              </div> : (num > 30 && num < 80) ?
                                <div className='flex flex-col gap-1'>
                                  ...
                                  <div className='flex flex-col gap-1'>
                                    ...
                                    <p className='font-normal leading-snug'>Email Address is associated with a valid account and it also should be emailed.</p>
                                  </div> :
                                  <div className='flex flex-col gap-1'>
                                    <h3 className='text-[13px] font-medium md:text-[15px]'>Deliverable</h3>
                                    <p className='font-normal leading-snug'>Email Address is associated with a valid account and it also should be emailed.</p>
                          ...
                          <div className='font-light flex  items-center gap-1'><div className='rounded-full p-[2px]' style={{ backgroundColor: (num > 0 && num < 30) ? '#ff4646bf' : (num > 30 && num < 80) ? '#fff7139e' : (num > 80 && num <= 100) ? '#56f44494' : '#56f44494', color: (num >= 0 && num < 30 ? 'white' : 'black') }}>{(num > 80 && num <= 100) ? <FaCheck className='text-[12px] text-white' /> : (num > 30 && num < 80) ? <RxQuestionMark className='text-[12px] text-black' /> : (num >= 0 && num < 30) ? <RxCross2 className='text-[12px] text-white' /> : <RxCross2 className='text-[12px] text-white' />}</div>{(num >= 0 && num < 30 ? 'UnDeliverable' : (num > 30 && num < 80) ? 'Riskfull' : 'Deliverable')}</div></div>
                        <div className='reason-tooltip relative cursor-pointer flex items-center justify-between text-xs mt-1 md:text-[15px]'>
                        <div className='reasontooltip-text -top-[70px] lg:-top-[85px]  duration-700 absolute bg-black text-white p-2 text-[10px] rounded-md '>
                            {(num >= 0 && num < 30) ?
                              <div className='flex flex-col gap-1'>
                                <h3 className='text-[13px] font-medium md:text-[15px]'>Rejected Email</h3>
                                <p className='font-normal leading-snug'>Email address was Rejected by the mail server because it does not exist.</p>
                              </div> : (num > 30 && num < 80) ?
                                <div className='flex flex-col gap-1'>
